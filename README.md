...
#### Sniff: Auto sniff for psn. Once run your buddies must join within 30 seconds. Should only be run after initial setup. Install jq prior to using this with ```apt install jq```.
